...
public class AppMessage extends FirebaseMessagingService {
        ...
        switch (usage) {
            case 1:
                ArrayList<Registration> registrations =
                        (ArrayList<Registration>) (List<?>) list;
                ...
                break;
            case 2 :     ArrayList<MyOrder> order =
                    (ArrayList<MyOrder>) (List<?>) list;
                for (MyOrder r : order) {
    ...
    public void addTask(NotificationData t) {
        ...
        NotificationData realmmessage =
                realm.createObject(NotificationData.class);
